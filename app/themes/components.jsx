...
export const components = {
    ...
    MuiAlert: {
        ...
        styleOverrides: {
            root: ({ ownerState }) => {
                var _a;
                const color = (_a = ownerState.color) !== null && _a !== void 0 ? _a : "info";
    ...
    MuiButton: {
        ...
        styleOverrides: {
            root: ({ ownerState }) => {
                var _a, _b, _c;
                const size = (_a = ownerState.size) !== null && _a !== void 0 ? _a : "md";
                const sizeStyles = (() => {
                    switch (size) {
                        case "xs":
                ...
                const color = getPaletteColor((_c = ownerState.color) !== null && _c !== void 0 ? _c : "secondary");
    ...
    MuiNativeSelect: {
        defaultProps: {
            IconComponent: ({ style, ...rest }) => {
                return (<Icon name="chevronDown" style={{
                        ...style,
                        cursor: "pointer",
                        color: "white",
                    }} {...rest}/>);
    ...
    MuiSelect: {
        ...
        styleOverrides: {
            root: ({ ownerState }) => {
                var _a, _b;
                const variant = (_a = ownerState.variant) !== null && _a !== void 0 ? _a : "outlined";
                const variantStyles = (() => {
                    switch (variant) {
                        case "outlined":
                            return {};
                ...
                const size = (_b = ownerState.size) !== null && _b !== void 0 ? _b : "md";
                const sizeStyles = (() => {
                    switch (size) {
                        case "xs":
    ...
    MuiTreeView: {
        defaultProps: {
            defaultCollapseIcon: (<Icon name="chevronRight" style={{
                    fontSize: 24,
                }}/>),
            defaultExpandIcon: (<Icon name="chevronRight" style={{
                    fontSize: 24,
                }}/>),
        },
        styleOverrides: {
