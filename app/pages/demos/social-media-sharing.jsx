...
export default function SocialMediaSharingDemo() {
    ...
    if (loading)
        return <DemoLoading />;
    if (error)
        return <DemoError error={error}/>;
    const sampleData = (data === null || data === void 0 ? void 0 : data.slice(0, 10)) || [
        { month: "Jan", value: 120 },
        { month: "Feb", value: 150 },
        { month: "Mar", value: 180 },
        { month: "Apr", value: 140 },
    ...
    return (<DemoLayout title="Social Media Sharing for Visualizations" description="Learn how to share your data visualizations on LinkedIn, X.com (Twitter), Facebook, and other social media platforms">
      <Grid container spacing={4}>
        ...
        <Grid item xs={12} lg={8}>
          <Paper elevation={2} sx={{ p: 3 }}>
            ...
            <Box ref={chartWrapperRef}>
              <ChartVisualizer data={sampleData} title="Monthly Data Trends" description="Sample data showing trends over time"/>
            </Box>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <PublishActions chartWrapperRef={chartWrapperRef} configKey="demo-social-sharing" locale={locale}/>
            </Box>
          </Paper>
        </Grid>
        ...
        <Grid item xs={12} lg={4}>
          <Paper elevation={2} sx={{ position: "sticky", top: 20 }}>
            <SocialMediaShare chartWrapperRef={chartWrapperRef} configKey="demo-social-sharing" locale={locale} chartTitle="Monthly Data Trends" chartDescription="Sample visualization showing data trends over time - created with visualize.admin.ch"/>
          </Paper>
        </Grid>
