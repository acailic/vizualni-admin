...
export default function TutorialCard({ tutorial, locale }) {
    ...
    return (<Card sx={{
      ...
      <CardActionArea component={Link} href={`/tutorials/${tutorial.id}`} sx={{
            height: "100%",
            display: "flex",
            flexDirection: "column",
            alignItems: "stretch",
        ...
        <CardContent sx={{ flexGrow: 1, p: 3 }}>
          ...
          <Box sx={{ display: "flex", flexWrap: "wrap", gap: 1, mb: 2 }}>
            {/* Difficulty */}
            <Chip label={difficultyLabels[locale][tutorial.difficulty]} size="small" color={difficultyColors[tutorial.difficulty]} sx={{
            fontWeight: 600,
            fontSize: "0.75rem",
            ...
            {/* Estimated Time */}
            <Chip label={`${tutorial.estimatedTime} min`} size="small" sx={{
            fontSize: "0.75rem",
            borderColor: "#667eea",
            color: "#667eea",
            fontWeight: 500,
            ...
            {/* Tag */}
            {tutorial.tags && tutorial.tags.length > 0 && (<Chip label={tutorial.tags[0]} size="small" sx={{
                fontSize: "0.75rem",
                borderColor: "#f5576c",
                color: "#f5576c",
                fontWeight: 500,
