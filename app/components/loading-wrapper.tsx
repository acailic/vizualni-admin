 ...
 */
export const LoadingSpinner = ({ size = 40, fullPage = false }: { size?: number; fullPage?: boolean }) => {
  return (
    <Box
      sx={{
        display: "flex",
 ...
 */
export const LoadingOverlay = ({ loading, children }: { loading: boolean; children: ReactNode }) => {
  return (
